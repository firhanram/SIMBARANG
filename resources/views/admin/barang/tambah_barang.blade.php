                    ...
                    <div class="row pt-3">
                        <div class="col-sm-8 m-auto">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/barang/tambah_barang/add') }}" method="POST" class="needs-validation" novalidate>
                                        @csrf
                                        <div class="form-row">
                                            <div class="form-group col-sm-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="kd_barang" value="{{$autoNumber}}" required readonly>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" name="stok_barang" placeholder="Jumlah" class="form-control">
                                                </div>
                                            </div>
                                        </div>                             
